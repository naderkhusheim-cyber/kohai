...
const VALID_CONTROLS = ['say', 'motion', 'size', 'position', 'hide', 'show', 'walk', 'turn', 'pose', 'clear_pose', 'play_animation', 'skin', 'roommate', 'prop', 'lights', 'room', 'coding', 'asset', 'personality'];
